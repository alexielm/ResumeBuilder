...
export function Period(dateRange) {
    let startDate = Moment(dateRange.startDate).format("MMM yyyy");
    let endDate = dateRange.endDate ? Moment(dateRange.endDate).format("MMM yyyy") : "Present";
